...
HD_PWD='D:/Documents/PracticasArqui/arquitectura/P5/Archivo de Registros/Archivo de Registros.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fileReg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fileReg.tcl
