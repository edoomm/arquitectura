...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/P8/P8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fetch_memp_pila.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fetch_memp_pila.tcl -notrace
