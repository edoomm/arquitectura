...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/P8/P8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fetch_memp_pila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fetch_memp_pila.tcl
