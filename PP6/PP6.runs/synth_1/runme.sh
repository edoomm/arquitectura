...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/PP6/PP6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoriaDatos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoriaDatos.tcl
