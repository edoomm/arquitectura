...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/P6.2/P6.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoriaPrograma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoriaPrograma.tcl
