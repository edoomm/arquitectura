...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/P6.2/P6.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memoriaPrograma.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memoriaPrograma.tcl -notrace
