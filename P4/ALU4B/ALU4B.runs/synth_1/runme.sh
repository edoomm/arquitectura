...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/P4/ALU4B/ALU4B.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU4B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU4B.tcl
