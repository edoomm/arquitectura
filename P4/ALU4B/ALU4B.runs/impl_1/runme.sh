...
HD_PWD='D:/Documents/PracticasArqui/arquitectura/P4/ALU4B/ALU4B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU4B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU4B.tcl -notrace
