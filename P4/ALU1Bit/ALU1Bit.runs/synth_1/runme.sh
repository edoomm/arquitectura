...
HD_PWD='D:/Documents/PracticasArqui/arquitectura/P4/ALU1Bit/ALU1Bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU1Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU1Bit.tcl
