...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/P7/P7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stack.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stack.tcl -notrace
