...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/P6/P6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoDatos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoDatos.tcl
