...
HD_PWD='C:/Users/Abraham/Documents/GitHub/arquitectura/P9/ASM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log asm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source asm.tcl -notrace
