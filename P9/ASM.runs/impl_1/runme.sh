...
HD_PWD='C:/Users/mara0/Documents/ESCOM6/PracticasArquitectura/arquitectura/P9/ASM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p9.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p9.tcl -notrace
