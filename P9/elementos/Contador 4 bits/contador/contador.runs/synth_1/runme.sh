...
HD_PWD='C:/Users/Abraham/Documents/GitHub/arquitectura/P9/elementos/Contador 4 bits/contador/contador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contador.tcl
