...
HD_PWD='C:/Users/Abraham/Documents/arqui prac 9/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arreglo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arreglo.tcl
