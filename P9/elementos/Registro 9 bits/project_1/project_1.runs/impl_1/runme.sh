...
HD_PWD='C:/Users/Abraham/Documents/arqui prac 9/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arreglo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arreglo.tcl -notrace
