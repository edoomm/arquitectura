...
HD_PWD='C:/Users/Abraham/Documents/GitHub/arquitectura/P9/elementos/cartaASM/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cartaASM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cartaASM.tcl -notrace
