...
HD_PWD='D:/Documents/PracticasArqui/arquitectura/P1/SumadorRestador4Bits/SumadorRestador4Bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador4.tcl
