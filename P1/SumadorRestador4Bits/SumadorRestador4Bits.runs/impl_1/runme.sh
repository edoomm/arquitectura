...
HD_PWD='D:/Documents/PracticasArqui/arquitectura/P1/SumadorRestador4Bits/SumadorRestador4Bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumador4.tcl -notrace
